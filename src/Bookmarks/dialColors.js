import { getColorsByShade } from "random-color-library/dist/materialColors.js";
...
function randomIntFromHash(key, max) {
  ...
  // Apply a bias to reduce results which map to red
...
function dialColors(name) {
  ...
  // If name matches key, return color.
  ...
  // Otherwise return pseudo-random color.
